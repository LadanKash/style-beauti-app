...
//           padding: 14,
//           paddingBottom: 14 + FOOTER_H + 20, // space for fixed footer
//         }}
//       >
...
//               <Text style={{ fontSize: 24, fontWeight: "500", color: "#1F1F1F" }}>
//                 Find my routine
//               </Text>
//               <Text style={{ marginTop: 6, opacity: 0.72, fontSize: 14, lineHeight: 20 }}>
//                 Answer 3 quick questions — we’ll recommend products that match your needs and
//                 budget.
//               </Text>
//             </View>

//             <Pressable onPress={() => router.push("/(tabs)/explore")} style={{ paddingTop: 10 }}>
//               <Text style={{ fontWeight: "600", color: "#1F1F1F" }}>Browse →</Text>
//             </Pressable>
//           </View>
...
//                   {["skincare", "haircare", "clothing", "bags", "shoes", "accessories"].map((c) => (
//                     <Chip
//                       key={c}
...
//                   }}
//                 >
//                   <Text style={{ fontWeight: "700", color: "#1F1F1F" }}>Back</Text>
//                 </Pressable>
//               )}
...
//                 }}
//               >
//                 <Text style={{ fontWeight: "800" }}>{loading ? "…" : results.length}</Text>
//               </View>
//             </View>
...
export default function RoutineIndex() {
  ...
  // IMPORTANT: inside component so it can access category/concern/budget/results
  const onSaveRoutine = async () => {
    ...
    try {
      ...
      // 👇 debug test (you can remove later)
      ...
      >
        <View style={{ alignSelf: "center", width: "100%", maxWidth: CARD_MAX }}>
          ...
          >
            ...
            {step === 1 && (
              <>
                <Text style={{ marginTop: 12, fontSize: 16, fontWeight: "500", color: "#1F1F1F" }}>
                  What are you shopping for?
                </Text>
                <Text style={{ marginTop: 6, opacity: 0.7 }}>Choose a category.</Text>
            ...
            <View style={{ marginTop: 16, flexDirection: "row", gap: 12 }}>
              ...
              <Pressable
                onPress={goContinue}
                disabled={(step === 1 && !category) || (step === 2 && !concern) || (step === 3 && !budget)}
                style={{
                  flex: 1,
                  backgroundColor:
          ...
          >
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
              ...
              >
                <Text style={{ fontWeight: "700" }}>{loading ? "…" : results.length}</Text>
              </View>
            </View>
