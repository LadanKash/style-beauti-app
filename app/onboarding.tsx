...
//   return (
//     <View style={{ flex: 1, backgroundColor: "#F5DFDC" }}>
//       {/* Top bar */}
//       <View style={{ paddingTop: 18, paddingHorizontal: 18, flexDirection: "row", justifyContent: "space-between" }}>
...
//         <Pressable onPress={skip} style={{ paddingVertical: 8, paddingHorizontal: 8 }}>
...
//             {/* Buttons */}
//             <View style={{ flexDirection: "row", gap: 10, backgroundColor: theme.background  }}>
//               {index > 0 && (
//                 <Pressable
//                   onPress={() => setIndex((v) => v - 1)}
//                   style={{ paddingVertical: 10, paddingHorizontal: 14, borderRadius: 999, backgroundColor: "rgba(0,0,0,0.06)" }}
//                 >
...
//   return (
//     <View style={{ flex: 1, backgroundColor: "#F5DFDC" }}>
//       {/* ✅ FIXED TOP BAR (Safe Area + absolute so it's always clickable) */}
...
//           }}
//         >
//           <Pressable onPress={() => router.back()} hitSlop={16} style={{ paddingVertical: 6, paddingHorizontal: 6 }}>
//             <Text style={{ fontSize: 14, color: "#6B6B6B", opacity: 0.9 }}>← Back</Text>
//           </Pressable>

//           <Pressable onPress={skip} hitSlop={16} style={{ paddingVertical: 6, paddingHorizontal: 6 }}>
//             <Text style={{ fontSize: 14, color: "#6B6B6B", opacity: 0.9 }}>Skip</Text>
//           </Pressable>
//         </View>
//       </SafeAreaView>

//       {/* ✅ PUSH CONTENT DOWN so it does not go behind status bar/top bar */}
//       <ScrollView contentContainerStyle={{ padding: 18, paddingBottom: 28, paddingTop: 70 }}>
//         <View
//           style={{
//             backgroundColor: "#F7F7F4",
//             borderRadius: 28,
