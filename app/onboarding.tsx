...
//   const completeAndGo = React.useCallback(
//     async (path: string) => {
//       try {
//         await AsyncStorage.setItem(KEY, "true");
//       } catch {}
...
//       try {
//         const done = (await AsyncStorage.getItem(KEY)) === "true";
//         if (alive && done) router.replace("/routine");
//       } catch {}
//     })();
//     return () => {
//       alive = false;
...
//   const skip = () => completeAndGo("/(tabs)");
//   const goRoutine = () => completeAndGo("/routine");
//   const goSuggest = () => completeAndGo("/suggest");
...
//                 </Pressable>
//               ) : (
//                 // ✅ On last step: stack actions so nothing gets clipped
...
//                   <Pressable onPress={goSuggest} style={{ paddingVertical: 10, paddingHorizontal: 8 }}>
//                     <Text style={{ fontWeight: "800", color: "#2B2B2B", opacity: 0.75 }}>
//                       AI suggestions
//                     </Text>
//                   </Pressable>
//                 </View>
