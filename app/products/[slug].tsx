    ...
    <Page backgroundColor="#F7F7F4">
      ...
      {loading ? (
        ...
        <View style={{ padding: 20 }}>
          <Text style={{ color: "#2A2A2A" }}>{error}</Text>
          <Text style={{ marginTop: 6, opacity: 0.7 }}>Make sure products.json is reachable.</Text>
        </View>
      ) : !product ? (
        <View style={{ padding: 20 }}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={{ padding: 20 }}>
            ...
            {/* <Text style={{ fontSize: 18, color: "#6B6B6B", fontWeight: "400", marginBottom: 12 }}>
              ${product.price} {product.currency ?? "CAD"}
            </Text> */}

           <Text style={{ fontSize: 15, color: "#6B6B6B", fontWeight: "400", marginBottom: 12 }}>
         {product.brand} • {product.budget} • Check price from retailer
         </Text>
            ...
            {!!product.tag && (
              ...
              >
                <Text style={{ fontWeight: "600", color: "#2A2A2A" }}>{product.tag}</Text>
              </View>
            )}
